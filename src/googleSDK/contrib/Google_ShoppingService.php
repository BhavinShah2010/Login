...
class Google_ShoppingService extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    ...
    $this->products = new Google_ProductsServiceResource($this, $this->serviceName, 'products', json_decode('{"methods"../../contrib/ {"list"../../contrib/ {"scopes": ["https://www.googleapis.com/auth/shoppingapi"], "parameters"../../contrib/ {"facets.include"../../contrib/ {"type": "string", "location": "query"}, "plusOne.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "plusOne.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "facets.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "relatedQueries.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "promotions.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "channels"../../contrib/ {"type": "string", "location": "query"}, "currency"../../contrib/ {"type": "string", "location": "query"}, "startIndex"../../contrib/ {"type": "integer", "location": "query", "format": "uint32"}, "facets.discover"../../contrib/ {"type": "string", "location": "query"}, "categoryRecommendations.category"../../contrib/ {"type": "string", "location": "query"}, "availability"../../contrib/ {"type": "string", "location": "query"}, "crowdBy"../../contrib/ {"type": "string", "location": "query"}, "spelling.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "taxonomy"../../contrib/ {"type": "string", "location": "query"}, "spelling.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "source"../../contrib/ {"required": true, "type": "string", "location": "path"}, "useCase"../../contrib/ {"type": "string", "location": "query"}, "location"../../contrib/ {"type": "string", "location": "query"}, "maxVariants"../../contrib/ {"type": "integer", "location": "query", "format": "int32"}, "categories.include"../../contrib/ {"type": "string", "location": "query"}, "boostBy"../../contrib/ {"type": "string", "location": "query"}, "safe"../../contrib/ {"type": "boolean", "location": "query"}, "categories.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "maxResults"../../contrib/ {"type": "integer", "location": "query", "format": "uint32"}, "facets.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "categories.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "plusOne.styles"../../contrib/ {"type": "string", "location": "query"}, "attributeFilter"../../contrib/ {"type": "string", "location": "query"}, "clickTracking"../../contrib/ {"type": "boolean", "location": "query"}, "categoryRecommendations.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "thumbnails"../../contrib/ {"type": "string", "location": "query"}, "language"../../contrib/ {"type": "string", "location": "query"}, "categoryRecommendations.include"../../contrib/ {"type": "string", "location": "query"}, "country"../../contrib/ {"type": "string", "location": "query"}, "rankBy"../../contrib/ {"type": "string", "location": "query"}, "restrictBy"../../contrib/ {"type": "string", "location": "query"}, "q"../../contrib/ {"type": "string", "location": "query"}, "redirects.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "redirects.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "relatedQueries.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "categoryRecommendations.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "promotions.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}}, "id": "shopping.products.list", "httpMethod": "GET", "path": "{source}/products", "response"../../contrib/ {"$ref": "Products"}}, "get"../../contrib/ {"scopes": ["https://www.googleapis.com/auth/shoppingapi"], "parameters"../../contrib/ {"categories.include"../../contrib/ {"type": "string", "location": "query"}, "recommendations.enabled"../../contrib/ {"type": "boolean", "location": "query"}, "thumbnails"../../contrib/ {"type": "string", "location": "query"}, "plusOne.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "source"../../contrib/ {"required": true, "type": "string", "location": "path"}, "taxonomy"../../contrib/ {"type": "string", "location": "query"}, "productIdType"../../contrib/ {"required": true, "type": "string", "location": "path"}, "categories.useGcsConfig"../../contrib/ {"type": "boolean", "location": "query"}, "plusOne.styles"../../contrib/ {"type": "string", "location": "query"}, "recommendations.include"../../contrib/ {"type": "string", "location": "query"}, "categories.enabled": {"type": "boolean", "location": "query"}, "location": {"type": "string", "location": "query"}, "plusOne.enabled": {"type": "boolean", "location": "query"}, "attributeFilter": {"type": "string", "location": "query"}, "recommendations.useGcsConfig": {"type": "boolean", "location": "query"}, "productId": {"required": true, "type": "string", "location": "path"}, "accountId": {"required": true, "type": "integer", "location": "path", "format": "uint32"}}, "id": "shopping.products.get", "httpMethod": "GET", "path": "{source}/products/{accountId}/{productIdType}/{productId}", "response": {"$ref": "Product"}}}}', true));
